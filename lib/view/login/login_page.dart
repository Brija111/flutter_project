                  ...
                  child: Expanded(
                    ...
                    child: Container(
                      decoration: BoxDecoration(color: AppColor.background,
                          image: DecorationImage(image: AssetImage(Images.login),alignment: Alignment.bottomCenter)),
                      child: Column(
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "Please sign in to your account and start tracking your assets",
                               ...
                               ResponsiveRowColumn(
                                 ...
                                 layout: ResponsiveWrapper.of(context).isTablet
                                        ...
                                        ResponsiveRowColumnItem(
                                          child: TextButton(
                                            ...
                                            child: Text("Forgot Password?",
                                              style:AppTextStyle.body2.copyWith(fontSize: 14,color: AppColor.primary)),
                                          ),
                                        ),
                                ...
                                Center(
                                  child: Wrap(
                                    children: [
                                      Text("New on our platform?", style: AppTextStyle
                                          .inputText.copyWith(
                                          fontSize: 16,
                                          color: AppColor.textOnSecondary),),
                                      TextButton(
